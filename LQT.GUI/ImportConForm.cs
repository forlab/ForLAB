    ...
    public partial class ImportConForm : Form
    {
        ...
        private void butSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show(_count + " Consumption data imported and saved successfully."+ Environment.NewLine + _error + " Failed", "Importing", MessageBoxButtons.OK, MessageBoxIcon.Information);
