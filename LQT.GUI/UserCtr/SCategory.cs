...
{
    public partial class SCategory : BaseHistoricalData
    {
        ...
        private void lvCategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                _activeCategory = (ForecastCategory)lvCategory.SelectedItems[0].Tag;
                txtSitename.Text = _activeCategory.CategoryName;
                txtPcount.Text = _activeCategory.GetUniqFCTest().Count.ToString();
        ...
        private void lbtAddtv_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
